...
class TestPurchasePlaces:
    ...
    def test_purchase_places_should_reduce_club_points_success(
        ...
        it should return a 200 HTTP code (OK), the response should contain some text and the competition should have a reduction of it's available places.
        """
        response = client.post(
            "/purchasePlaces",
            data={
...
class TestDisplayPoints:
    ...
    def test_post_display_clubs_points_should_fail(self, client):
        ...
        assert response.status_code == 404  # should be 405
